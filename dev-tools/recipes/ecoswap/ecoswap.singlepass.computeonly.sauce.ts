...
//
// This is `ecoswap.singlepass.sauce.ts` (the array-mutation single-pass live-cut
// solver) with the EXECUTION stripped out: no transferFrom, no router.swap*/swapV3,
...
// The KEY comparison is this vs ecoswap.computeonly.sauce.ts (the all-scalar two-pass
// compute-only) across {v1, v12} — isolating the array/dynamic-data overhead.
