 ...
 *
 *   BASE_RPC_URL=<url> npx tsx recipes/test/harness/prod-snapshot.ts [poolAddressOrPair]
 *
 ...
 *   recipes/test/fixtures/snapshots/<chain>-<symbol0><symbol1>-<fee>.json
 *
  ...
  if (!rpcUrl) {
    console.error(
      "prod-snapshot: BASE_RPC_URL is not set.\n" +
        ...
        "    BASE_RPC_URL=https://eth-mainnet-... npx tsx recipes/test/harness/prod-snapshot.ts\n" +
