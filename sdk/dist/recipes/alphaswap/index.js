 ...
 */
export async function alphaSwap(config, rpcUrl, sauceRouterAddress, caller) {
    ...
    console.log(`  Discovered: ${prepared.directPools.length} direct pools, ${prepared.multiHopRoutes.length} multi-hop routes`);
