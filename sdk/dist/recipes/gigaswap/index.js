 ...
 */
function buildDirectPoolTuple(p) {
    return [
 ...
 */
export async function gigaSwap(config, rpcUrl, sauceRouterAddress, caller) {
    ...
    console.log(`  GigaSwap: ${prepared.priceLimitedPools.length} V3 pools, ` +
