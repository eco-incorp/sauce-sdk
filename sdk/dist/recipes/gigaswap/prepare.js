...
import { MIN_SQRT_RATIO, MAX_SQRT_RATIO, BASE_CHAIN_POOL_CONFIG } from "../shared/constants.js";
 ...
 */
export async function prepareGigaSwap(config, client, sauceRouterAddress, poolConfig = BASE_CHAIN_POOL_CONFIG) {
    ...
    console.log(`  GigaSwap prepared: ${priceLimitedPools.length} V3 (price-limited), ` +
