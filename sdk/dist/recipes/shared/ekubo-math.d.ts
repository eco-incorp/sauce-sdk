...
export declare const EKUBO_INT128_MAX: bigint;
/** Core.sload raw-key batch-read selector (ExposedStorage; selector ++ N×32-byte keys). */
export declare const EKUBO_SLOAD_SELECTOR: Hex;
 ...
 */
export declare const EKUBO_DEFAULT_PRESETS: EkuboPreset[];
/**
 ...
 */
export declare function ekuboConcentratedConfig(fee: bigint, tickSpacing: number): Hex;
/**
 ...
 */
export declare function ekuboPoolId(token0: Hex, token1: Hex, config: Hex): Hex;
/** Diagnostic ppm from the u64 0.64-fixed fee word: round(fee × 1e6 / 2^64). */
export declare function ekuboFeePpm(fee: bigint): number;
/**
 ...
 */
export declare function decodeEkuboBalanceUpdate(word: bigint): {
    delta0: bigint;
    delta1: bigint;
};
/**
 ...
 */
export declare function buildEkuboQLLadder(pool: EkuboPool, amountIn: bigint): MergeSegment[];
//# sourceMappingURL=ekubo-math.d.ts.map