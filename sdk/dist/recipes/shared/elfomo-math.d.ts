...
export declare const ELFOMO_FEE_SCALE: bigint;
/**
 ...
 * stream consumes.
 */
export declare function buildElfomoQLLadder(pool: ElfomoPool, amountIn: bigint): MergeSegment[];
//# sourceMappingURL=elfomo-math.d.ts.map