 ...
 * of them is not.
 */
export const INFINITY_RETURNS_DELTA_MASK = 15360n; // bits 10..13
/**
 ...
 */
export const INFINITY_DEFAULT_CL_PRESETS = [
 ...
 */
export function encodeInfinityCLParameters(tickSpacing) {
...
export function decodeInfinityCLTickSpacing(parameters) {
...
export function decodeInfinityHookBitmap(parameters) {
 ...
 */
export function computeInfinityPoolId(currency0, currency1, hooks, poolManager, fee, parameters) {
 ...
 */
export function combineInfinityFee(protocolFee, lpFee, zeroForOne) {
...
//# sourceMappingURL=infinity-math.js.map