...
export declare const MENTO_FEE_SCALE: bigint;
/**
 ...
 */
export declare const MENTO_SAMPLES: number;
/**
 ...
 */
export declare function mentoSampleInputs(amountIn: bigint, samples?: number): bigint[];
/**
 ...
 */
export declare function getAmountOut(pool: MentoPool, dx: bigint): bigint;
/**
 ...
 */
export declare function mentoQuoteClosed(m: MentoClosedModel, dx: bigint): bigint;
/**
 ...
 */
export declare function buildMentoSegments(pool: MentoPool, amountIn: bigint, _samples?: number): MentoSegment[];
/**
 ...
 */
export declare function buildMentoQLLadder(pool: MentoPool, amountIn: bigint): MentoSegment[];
//# sourceMappingURL=mento-math.d.ts.map