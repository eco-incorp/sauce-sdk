...
export declare const PANCAKE_STABLE_FEE_DENOMINATOR = 10000000000n;
/**
 ...
 * it as `aPrecision: 1n`.
 */
export declare const PANCAKE_STABLE_A_PRECISION = 1n;
/**
 ...
 */
export declare function pancakeStableGetDy(state: PancakeStableState, i: number, j: number, dx: bigint): bigint;
/**
 ...
 */
export declare function pancakeStableExchangeDy(state: PancakeStableState, i: number, j: number, dx: bigint): bigint;
/**
 ...
 */
export declare function buildPancakeStableQLLadder(pool: PancakeStablePool, amountIn: bigint): MergeSegment[];
//# sourceMappingURL=pancakestable-math.d.ts.map