...
const sauceRouterArtifact = JSON.parse(readFileSync(join(__dirname, "..", "..", "artifacts", "ISauceRouter.json"), "utf-8"));
 ...
 */
export async function quotePool(pool, amountIn, sqrtPriceLimitX96, sauceRouterAddress, client) {
