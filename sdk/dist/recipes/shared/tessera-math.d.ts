...
export declare const TESSERA_FEE_SCALE: bigint;
/**
 ...
 */
export declare function buildTesseraQLLadder(pool: TesseraPool, amountIn: bigint): MergeSegment[];
//# sourceMappingURL=tessera-math.d.ts.map