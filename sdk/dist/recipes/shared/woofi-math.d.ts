...
export declare const WOO_WAD: bigint;
/** WooPPV2 fee scale — feeRate is 1e5-scaled (0.025% = 25). */
export declare const WOO_FEE_SCALE: bigint;
 ...
 */
export declare function wooFiInputCap(pool: WooFiPool, fallbackMax: bigint): bigint;
/**
 ...
 */
export declare function query(pool: WooFiPool, dx: bigint): bigint;
/**
...
export declare const WOOFI_SAMPLES: number;
/**
 ...
 */
export declare function buildWooFiQLLadder(pool: WooFiPool, amountIn: bigint): WooFiSegment[];
export declare function buildWooFiSegments(pool: WooFiPool, amountIn: bigint, samples?: number): WooFiSegment[];
//# sourceMappingURL=woofi-math.d.ts.map