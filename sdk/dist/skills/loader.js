 ...
 */
export function getProtocolIndex() {
 ...
 */
export function getProtocolSkill(slug) {
    const filePath = join(skillsDir, `${slug}.md`);
    try {
        return readFileSync(filePath, "utf-8");
    }
    catch {
        throw new Error(`No skill file found for protocol "${slug}". Check listSkillSlugs() for valid slugs.`);
    }
}
/**
