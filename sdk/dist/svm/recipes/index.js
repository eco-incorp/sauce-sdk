...
export const SVM_SETTLE_SOURCE_PATH = join(__dirname, "settle.sauce.ts");
function assertEscrowCount(fn, escrowCount) {
 ...
 */
export function svmSettleSource(escrowCount = 1) {
 ...
 */
export function svmSettleRefs(escrowCount = 1) {
