...
export const boopFunLadder = {
    ...
    continuousFees(base, _state, params) {
        const cfg = asCfg(base);
        const [feeBps] = params;
        const gamma = ((BPS - feeBps) * 1000000n) / BPS;
        return cfg.direction === 'quoteToBase' ? { gammaPpm: gamma, muPpm: 1000000n } : { gammaPpm: 1000000n, muPpm: gamma };
    },
};
