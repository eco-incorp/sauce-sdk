...
export const flintLadder = {
    ...
    referenceQuote(base, state) {
        ...
        if (vinData === undefined)
            throw new Error(`${SLUG} reference is missing vault ${d.vaultIn}`);
        if (voutData === undefined)
            throw new Error(`${SLUG} reference is missing vault ${d.vaultOut}`);
        ...
        return (x) => {
            ...
            return (raw * haircutPpm) / 1000000n;
        };
    },
    ...
    continuousFees(base) {
        ...
        // actually quotes.
        return { gammaPpm: 1000000n, muPpm: haircutFor(flintConfig(base)) };
    },
};
