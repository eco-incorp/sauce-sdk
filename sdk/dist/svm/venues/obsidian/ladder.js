...
function priceScaleFraction(decimalsA, decimalsB) {
...
export const obsidianLadder = {
    ...
    referenceQuote(base, state) {
        ...
        if (vaultOutData === undefined)
            throw new Error(`${SLUG} reference is missing the output vault`);
    ...
    continuousFees() {
        ...
        return { gammaPpm: 1000000n, muPpm: (BPS_DEN - OUT_DISCOUNT_BPS) * 100n };
    },
};
