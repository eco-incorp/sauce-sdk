...
const SLUG = 'xorca';
export const XORCA_PROGRAM_ID = address('StaKE6XNKVVhG8Qu9hDJBqCW3eRe7MDGLz17nJZetLT');
 ...
 */
export const XORCA_STATE_PDA = address('CSqKhyW1cpdyjheAx5HXx4ibcnYrzpL5JywEMAkZixBK');
export const XORCA_VAULT_ATA = address('Ce5j11WAsSzM3nkzrw4Kw6v6ic3nbyqpv5eywjYKeKc5');
 ...
 */
export async function fetchXorcaConfig(load, pool) {
    ...
    if (raw === null)
        throw new Error(`${SLUG}: state account ${pool} not found`);
