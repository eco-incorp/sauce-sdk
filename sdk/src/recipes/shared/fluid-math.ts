 ...
 * non-decreasing marginal (rounding noise, or past where the cap collapses the quote) is dropped so the
 * merge stays strictly price-ordered. Mirrors `buildFermiSegments` / `buildWooFiSegments` (same
