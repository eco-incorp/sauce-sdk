...
export const HYPEREVM_BBO_PRECOMPILE = "0x000000000000000000000000000000000000080e" as Hex;
 ...
 */
export function buildLiquidCoreQLLadder(pool: LiquidCorePool, amountIn: bigint): MergeSegment[] {
