...
async function resolveWindow(
  ...
  const boundaries: PancakeswapClmmBoundary[] = [];
 ...
 */
export async function fetchPancakeswapClmmConfig(load: AccountLoader, pool: Address): Promise<PancakeswapClmmPoolConfig> {
