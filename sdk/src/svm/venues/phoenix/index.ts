...
function emitOrderRead(p: string, k: number, params: readonly string[], nodesBaseExpr: string, mktRef: string): string[] {
...
export function phoenixPatchDivisor(base: PoolConfig): bigint {
  const cfg = phoenixConfig(base);
