 ...
 */
export const REGISTRY_K: Record<string, bigint> = {
...
export const solfiV2 = {
  ...
  async fetchPoolConfig(load: AccountLoader, pool: Address, direction: 0 | 1 = 0): Promise<SolfiV2PoolConfig> {
    ...
    if (registryK === undefined) {
      throw new Error(
        `solfi-v2 pool ${pool} points at an unrecognized registry ${registry} (no proven/disclosed additive-impact constant K for it)`,
      );
    }
