 ...
 */
export const SETTLE_TEMPLATES: readonly TemplateEntry[] = Object.freeze([
  Object.freeze({
    id: "ecoswap-settle",
    version: "1",
    bodyHash: "0x71e6bf2c268ec859528f932288f6ce3a02d33cfad2125c0ce0e23c57d1720d3b" as Hex,
    bodySize: 165,
    compilerSha: "f540ca693e89ea2327971d2ad7a356ba7d80df6a",
    status: "current" as TemplateStatus,
    since: "2026-07",
    notes:
      "programs/token-sweep.sauce.ts main(tokens, minOut, recipient) — sweeps the Pot's CURRENT balance of every " +
...
export const CURRENT_SETTLE_TEMPLATE: TemplateEntry = SETTLE_TEMPLATES.find(
  (t) => t.id === "ecoswap-settle" && t.status === "current",
)!;
